...
while True:
    ...
    cmd = "hostname -I | cut -d\' \' -f 2"
    Disk = subprocess.check_output(cmd, shell = True )
    # cmd = "vcgencmd measure_temp |cut -f 2 -d '='"
    # Temp = subprocess.check_output(cmd, shell = True )

    # Pi Stats Display
    draw.text((0, 0), "IPe: " + str(IP,'utf-8'), font=font, fill=255) 
    draw.text((0, 16), "IPw: " + str(Disk,'utf-8'), font=font, fill=255)
    # draw.text((0, 16), "Yo Mom, a Hoe.", font=font, fill=255)
